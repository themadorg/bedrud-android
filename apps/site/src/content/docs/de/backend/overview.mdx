...
- **Deployment:** Integrierter Debian/Ubuntu-Auto-Installer mit Init-System-Orchestrierung (systemd, OpenRC, SysV init) und ACME (Let's Encrypt)-Unterstützung.
...
3.  Die Konfiguration auf Betriebssystemebene (SSL, Init-Services) automatisch über das Binary selbst **verwaltet**.
