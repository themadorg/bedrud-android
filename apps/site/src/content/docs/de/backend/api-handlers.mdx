---
title: API-Handler
description: REST-API-Endpunkt-Implementierungen
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/de/docs/api/api-reference).
...
- [Authentication](/de/docs/backend/authentication)
- [Webhooks Guide](/de/docs/guides/webhooks)
- [Configuration](/de/docs/getting-started/configuration)
