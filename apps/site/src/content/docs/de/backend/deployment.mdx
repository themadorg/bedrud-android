...
Replaces the binary with the running executable, runs versioned install migrations and DB AutoMigrate, refreshes init units, and restarts services. See [Updating](/de/docs/getting-started/installation#updating).
