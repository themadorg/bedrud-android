...
description: E2EE-Architektur, aktuelle Implementierung und geplante clientseitige Verschlüsselung
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/de/e2ee).
...
- [WebRTC Connectivity](/de/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/de/docs/architecture/turn-server) — TURN relay configuration
