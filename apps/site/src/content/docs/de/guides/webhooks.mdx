---
title: Webhooks
description: Webhook-Ereignisse konfigurieren und verwalten
order: 37
---
...
- [Admin Dashboard](/de/docs/guides/admin-dashboard) — UI for managing webhooks
- [API Reference](/de/docs/api/api-reference) — Admin webhook endpoints in OpenAPI
