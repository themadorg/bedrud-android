...
> See [Server Architecture](/de/docs/architecture/server) for the full directory layout and layered design.
...
> See [Web Frontend Architecture](/de/docs/architecture/web) for the complete frontend structure and patterns.
...
> See [Android App Architecture](/de/docs/architecture/android) for detailed mobile app architecture.
...
> See [iOS App Architecture](/de/docs/architecture/ios) for detailed mobile app architecture.
...
> See [Desktop App Architecture](/de/docs/architecture/desktop) for detailed desktop app architecture.
...
- [Makefile Reference](/de/docs/guides/makefile) - all build and dev commands
- [Architecture Overview](/de/docs/architecture/overview) - how components fit together
