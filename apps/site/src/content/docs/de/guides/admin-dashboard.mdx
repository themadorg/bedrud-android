...
Die Einstellungsseite unter `/dashboard/admin/settings` ist in 7 Tabs unterteilt. Klicken Sie auf „Änderungen speichern", nachdem Sie einen Tab bearbeitet haben (der Allgemein-Tab speichert bei Änderungen des Registrierungsmodus automatisch).
...
- [Admin-API](/en/docs/api/admin) – vollständige API-Referenz für alle Admin-Endpunkte
