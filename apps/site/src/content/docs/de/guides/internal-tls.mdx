...
## See also
- [Installation Guide](/de/docs/getting-started/installation) - install methods
- [Configuration Reference](/de/docs/getting-started/configuration) - full config options
