...
- [Configuration Reference](/de/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/de/docs/guides/deployment) - production deployment with Docker
