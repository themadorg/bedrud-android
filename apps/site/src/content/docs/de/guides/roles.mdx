...
## Moderations-UI im Meeting

Raumersteller und beförderte Moderatoren nutzen das Teilnehmer-Kontextmenü sowie Stage-/Share-Steuerung während eines Anrufs. Zum hostseitigen Verhalten (stummschalten, kicken, Bildschirmfreigabe stoppen, Spotlight, Stage) siehe [Meeting-Steuerung](/de/docs/using/meeting-controls) und [Stage-Modus](/de/docs/using/stage-mode).
