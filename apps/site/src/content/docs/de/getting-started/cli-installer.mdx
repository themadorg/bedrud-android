...
For server setup after installing, see [Quick Start](/de/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/de/docs/getting-started/installation).
