...
server:
  ...
  trustedProxies: []            # Proxy IPs/CIDRs. Env: SERVER_TRUSTED_PROXIES (comma-separated)
...
chat:
  ...
  uploads:
    ...
    maxBytes: 10485760                   # Hard per-file limit (default 10 MB)
...
| `maxBytes` | Hard per-file limit (default 10 MB) |
