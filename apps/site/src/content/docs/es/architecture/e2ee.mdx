...
description: Arquitectura E2EE, implementación actual y cifrado planificado del lado del cliente
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/es/e2ee).
...
- [WebRTC Connectivity](/es/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/es/docs/architecture/turn-server) — TURN relay configuration
