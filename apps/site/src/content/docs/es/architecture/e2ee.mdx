...
> [!NOTE]
> ¿Busca un resumen de alto nivel o una demostración interactiva de flujo de paquetes WebRTC? Visite nuestra [página de inicio de cifrado de extremo a extremo](/es/e2ee).
