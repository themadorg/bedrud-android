...
- **Despliegue:** Instalador automático integrado para Debian/Ubuntu con orquestación del sistema de inicialización (systemd, OpenRC, SysV init) y soporte para ACME (Let's Encrypt).
...
3.  **Automatizar** la configuración a nivel de sistema operativo (SSL, servicios init) desde el propio binario.
