...
<Tabs>
  ...
  <TabsContent value="ubuntu-debian-apt">
    ...
    See the [Package Installation guide](/es/docs/guides/packages) for repository setup.
  </TabsContent>
...
For the complete reference of all package managers, repositories, and platforms, see the [Package Installation Guide](/es/docs/guides/packages).
