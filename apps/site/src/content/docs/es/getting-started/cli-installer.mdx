...
For server setup after installing, see [Quick Start](/es/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/es/docs/getting-started/installation).
