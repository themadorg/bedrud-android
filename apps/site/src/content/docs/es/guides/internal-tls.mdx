...
## See also
- [Installation Guide](/es/docs/getting-started/installation) - install methods
- [Configuration Reference](/es/docs/getting-started/configuration) - full config options
