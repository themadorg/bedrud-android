...
La página de configuración en `/dashboard/admin/settings` está organizada en 7 pestañas. Haga clic en "Guardar cambios" después de modificar cualquier pestaña (la pestaña General se guarda automáticamente al cambiar el modo de registro).
