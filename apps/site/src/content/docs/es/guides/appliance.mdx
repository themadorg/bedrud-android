...
| Instalador integrado | Configura servicios init (systemd/OpenRC/SysV), directorios y configuraciones |
...
Después de la instalación, se ejecutan dos servicios init (systemd, OpenRC o SysV init):
...
- Archivos de servicio init (systemd/OpenRC/SysV)
