...
> See [Server Architecture](/es/docs/architecture/server) for the full directory layout and layered design.
...
> See [Web Frontend Architecture](/es/docs/architecture/web) for the complete frontend structure and patterns.
...
> See [Android App Architecture](/es/docs/architecture/android) for detailed mobile app architecture.
...
> See [iOS App Architecture](/es/docs/architecture/ios) for detailed mobile app architecture.
...
> See [Desktop App Architecture](/es/docs/architecture/desktop) for detailed desktop app architecture.
...
- [Makefile Reference](/es/docs/guides/makefile) - all build and dev commands
- [Architecture Overview](/es/docs/architecture/overview) - how components fit together
