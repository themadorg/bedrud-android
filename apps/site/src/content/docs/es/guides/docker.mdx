...
- [Configuration Reference](/es/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/es/docs/guides/deployment) - production deployment with Docker
