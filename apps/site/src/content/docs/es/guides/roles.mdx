...
## UI de moderación en reunión

Los creadores de sala y los moderadores promocionados usan el menú contextual del participante y los controles de escenario/compartir durante una llamada. Para el comportamiento orientado al anfitrión (silenciar, expulsar, detener compartir pantalla, spotlight, escenario), ver [Controles de reunión](/es/docs/using/meeting-controls) y [Modo escenario](/es/docs/using/stage-mode).
