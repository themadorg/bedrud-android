...
Elimina una sala que hayas creado. Esto elimina permanentemente la sala y todos los datos asociados. Se ejecuta en segundo plano y regresa inmediatamente.
...
| 403 | No eres el creador (solo el creador puede eliminar) |
| 404 | Sala no encontrada |
| 409 | Eliminación ya en curso |
| 500 | Error del servidor |

Si la sala está activa, todos los participantes se desconectan y ven "This room has been ended by the creator".
...
| 403 | `"Room limit reached (max N active rooms)"` | Límite de sala alcanzado |
...
| 401 | No autenticado |
| 403 | No autorizado (no-admin intentando acción de admin) o límite de sala alcanzado |
| 404 | Sala no encontrada |
| 409 | Conflicto (recurso duplicado) |
| 500 | Error interno del servidor |
| 507 | Cuota de almacenamiento excedida (límite de carga o umbral global) |
