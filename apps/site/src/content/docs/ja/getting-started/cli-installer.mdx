...
For server setup after installing, see [Quick Start](/ja/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/ja/docs/getting-started/installation).
