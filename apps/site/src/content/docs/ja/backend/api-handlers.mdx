---
title: API ハンドラ
description: REST API エンドポイント実装
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/ja/docs/api/api-reference).
...
- [Authentication](/ja/docs/backend/authentication)
- [Webhooks Guide](/ja/docs/guides/webhooks)
- [Configuration](/ja/docs/getting-started/configuration)
