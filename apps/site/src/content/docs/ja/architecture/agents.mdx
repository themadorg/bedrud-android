...
> セットアップと使い方の詳細は [Music Agent README](https://github.com/themadorg/bedrud/tree/main/agents/music_agent) を参照してください。
...
> セットアップと使い方の詳細は [Radio Agent README](https://github.com/themadorg/bedrud/tree/main/agents/radio_agent) を参照してください。
...
> セットアップと使い方の詳細は [Video Stream Agent README](https://github.com/themadorg/bedrud/tree/main/agents/video_stream_agent) を参照してください。
...
- [Music Agent README](https://github.com/themadorg/bedrud/tree/main/agents/music_agent) - セットアップと使い方
- [Radio Agent README](https://github.com/themadorg/bedrud/tree/main/agents/radio_agent) - セットアップと使い方
- [Video Stream Agent README](https://github.com/themadorg/bedrud/tree/main/agents/video_stream_agent) - セットアップと使い方
