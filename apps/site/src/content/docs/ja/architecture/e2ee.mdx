---
title: エンドツーエンド暗号化
description: E2EEアーキテクチャ、現在の実装、および計画されているクライアント側暗号化
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/ja/e2ee).
...
- [WebRTC Connectivity](/ja/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/ja/docs/architecture/turn-server) — TURN relay configuration
