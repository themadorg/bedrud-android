...
> See [Server Architecture](/ja/docs/architecture/server) for the full directory layout and layered design.
...
> See [Web Frontend Architecture](/ja/docs/architecture/web) for the complete frontend structure and patterns.
...
> See [Android App Architecture](/ja/docs/architecture/android) for detailed mobile app architecture.
...
> See [iOS App Architecture](/ja/docs/architecture/ios) for detailed mobile app architecture.
...
> See [Desktop App Architecture](/ja/docs/architecture/desktop) for detailed desktop app architecture.
...
- [Makefile Reference](/ja/docs/guides/makefile) - all build and dev commands
- [Architecture Overview](/ja/docs/architecture/overview) - how components fit together
