...
## See also
- [Installation Guide](/ja/docs/getting-started/installation) - install methods
- [Configuration Reference](/ja/docs/getting-started/configuration) - full config options
