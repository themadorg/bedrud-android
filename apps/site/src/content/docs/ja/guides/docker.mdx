...
- [Configuration Reference](/ja/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/ja/docs/guides/deployment) - production deployment with Docker
