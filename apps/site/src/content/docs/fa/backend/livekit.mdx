---
title: یکپارچه‌سازی LiveKit
description: یکپارچه‌سازی سرور رسانه WebRTC
order: 20
---
...
- **TURN Port (3478 UDP / 5349 TLS):** Relays media for clients behind restrictive NATs or firewalls. See [TURN Server Guide](/fa/docs/architecture/turn-server).

For firewall and port requirements, see [WebRTC Connectivity](/fa/docs/architecture/webrtc-connectivity).
...
- [TURN Server Guide](/fa/docs/architecture/turn-server) - TURN architecture, configuration, TLS, and troubleshooting
