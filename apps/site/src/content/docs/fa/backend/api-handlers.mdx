---
title: هندلرهای API
description: پیاده‌سازی endpointهای REST
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/fa/docs/api/api-reference).
...
- [Authentication](/fa/docs/backend/authentication)
- [Webhooks Guide](/fa/docs/guides/webhooks)
- [Configuration](/fa/docs/getting-started/configuration)
