...
For server setup after installing, see [Quick Start](/fa/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/fa/docs/getting-started/installation).
