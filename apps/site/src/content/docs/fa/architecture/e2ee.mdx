...
description: معماری E2EE، پیاده‌سازی فعلی و رمزگذاری برنامه‌ریزی شده در سمت کاربر
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/fa/e2ee).
...
- [WebRTC Connectivity](/fa/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/fa/docs/architecture/turn-server) — TURN relay configuration
