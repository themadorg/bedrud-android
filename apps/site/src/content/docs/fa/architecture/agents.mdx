...
> برای دستورالعمل‌های راه‌اندازی و استفاده به [Music Agent README](https://github.com/themadorg/bedrud/tree/main/agents/music_agent) ببینید.
...
> برای دستورالعمل‌های راه‌اندازی و استفاده به [Radio Agent README](https://github.com/themadorg/bedrud/tree/main/agents/radio_agent) ببینید.
...
> برای دستورالعمل‌های راه‌اندازی و استفاده به [Video Stream Agent README](https://github.com/themadorg/bedrud/tree/main/agents/video_stream_agent) ببینید.
...
- [Music Agent README](https://github.com/themadorg/bedrud/tree/main/agents/music_agent) - راه‌اندازی و استفاده
- [Radio Agent README](https://github.com/themadorg/bedrud/tree/main/agents/radio_agent) - راه‌اندازی و استفاده
- [Video Stream Agent README](https://github.com/themadorg/bedrud/tree/main/agents/video_stream_agent) - راه‌اندازی و استفاده
