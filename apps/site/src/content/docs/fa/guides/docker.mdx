...
- [Configuration Reference](/fa/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/fa/docs/guides/deployment) - production deployment with Docker
