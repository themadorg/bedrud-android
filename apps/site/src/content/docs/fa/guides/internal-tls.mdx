...
## See also
- [Installation Guide](/fa/docs/getting-started/installation) - install methods
- [Configuration Reference](/fa/docs/getting-started/configuration) - full config options
