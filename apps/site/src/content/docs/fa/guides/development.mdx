...
> See [Server Architecture](/fa/docs/architecture/server) for the full directory layout and layered design.
...
> See [Web Frontend Architecture](/fa/docs/architecture/web) for the complete frontend structure and patterns.
...
> See [Android App Architecture](/fa/docs/architecture/android) for detailed mobile app architecture.
...
> See [iOS App Architecture](/fa/docs/architecture/ios) for detailed mobile app architecture.
...
> See [Desktop App Architecture](/fa/docs/architecture/desktop) for detailed desktop app architecture.
...
- [Makefile Reference](/fa/docs/guides/makefile) - all build and dev commands
- [Architecture Overview](/fa/docs/architecture/overview) - how components fit together
