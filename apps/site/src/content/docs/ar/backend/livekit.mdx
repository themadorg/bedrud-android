...
- **TURN Port (3478 UDP / 5349 TLS):** Relays media for clients behind restrictive NATs or firewalls. See [TURN Server Guide](/ar/docs/architecture/turn-server).

For firewall and port requirements, see [WebRTC Connectivity](/ar/docs/architecture/webrtc-connectivity).
...
- [TURN Server Guide](/ar/docs/architecture/turn-server) - TURN architecture, configuration, TLS, and troubleshooting
