---
title: معالجات API
description: تنفيذ نقاط نهاية REST
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/ar/docs/api/api-reference).
...
- [Authentication](/ar/docs/backend/authentication)
- [Webhooks Guide](/ar/docs/guides/webhooks)
- [Configuration](/ar/docs/getting-started/configuration)
