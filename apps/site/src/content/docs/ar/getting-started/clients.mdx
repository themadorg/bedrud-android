...
<Tabs>
  ...
  <TabsContent value="ubuntu-debian-apt">
    ...
    See the [Package Installation guide](/ar/docs/guides/packages) for repository setup.
  </TabsContent>
...
For the complete reference of all package managers, repositories, and platforms, see the [Package Installation Guide](/ar/docs/guides/packages).
