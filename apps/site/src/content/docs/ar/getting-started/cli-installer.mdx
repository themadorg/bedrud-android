...
For server setup after installing, see [Quick Start](/ar/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/ar/docs/getting-started/installation).
