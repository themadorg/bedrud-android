...
> See [Server Architecture](/ar/docs/architecture/server) for the full directory layout and layered design.
...
> See [Web Frontend Architecture](/ar/docs/architecture/web) for the complete frontend structure and patterns.
...
> See [Android App Architecture](/ar/docs/architecture/android) for detailed mobile app architecture.
...
> See [iOS App Architecture](/ar/docs/architecture/ios) for detailed mobile app architecture.
...
> See [Desktop App Architecture](/ar/docs/architecture/desktop) for detailed desktop app architecture.
...
- [Makefile Reference](/ar/docs/guides/makefile) - all build and dev commands
- [Architecture Overview](/ar/docs/architecture/overview) - how components fit together
