...
Room creators and promoted moderators use the participant context menu and stage/share controls during a call. For host-facing behavior (mute, kick, screen share stop, spotlight, stage), see [Meeting Controls](/ar/docs/using/meeting-controls) and [Stage Mode](/ar/docs/using/stage-mode).
