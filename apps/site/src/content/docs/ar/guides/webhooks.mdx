---
title: Webhooks
description: تكوين وإدارة أحداث Webhook
order: 37
---
...
- [Admin Dashboard](/ar/docs/guides/admin-dashboard) — UI for managing webhooks
- [API Reference](/ar/docs/api/api-reference) — Admin webhook endpoints in OpenAPI
