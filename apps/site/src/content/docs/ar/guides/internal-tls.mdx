...
## See also
- [Installation Guide](/ar/docs/getting-started/installation) - install methods
- [Configuration Reference](/ar/docs/getting-started/configuration) - full config options
