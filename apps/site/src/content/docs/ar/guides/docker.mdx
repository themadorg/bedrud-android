...
- [Configuration Reference](/ar/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/ar/docs/guides/deployment) - production deployment with Docker
