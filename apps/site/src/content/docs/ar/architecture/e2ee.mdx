---
title: التشفير التام بين الأطراف
description: معمارية E2EE، التنفيذ الحالي، والتشفير المخطط له من جانب العميل
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/ar/e2ee).
...
- [WebRTC Connectivity](/ar/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/ar/docs/architecture/turn-server) — TURN relay configuration
