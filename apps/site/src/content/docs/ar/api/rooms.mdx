...
احذف غرفة قمت بإنشائها. يؤدي هذا إلى إزالة الغرفة وجميع البيانات المرتبطة بها بشكل دائم. يتم وضعها في قائمة انتظار المهام الخلفية وتعود فوراً.
...
| 403 | لست منشئ الغرفة (يمكن للمنشئ فقط الحذف) |
| 404 | الغرفة غير موجودة |
| 409 | الحذف قيد التقدم بالفعل |
| 500 | خطأ في الخادم |

إذا كانت الغرفة نشطة، يتم فصل جميع المشاركين ويرون رسالة "This room has been ended by the creator".
...
| 403 | `"Room limit reached (max N active rooms)"` | تم الوصول إلى حد الغرفة |
...
| 401 | غير مُصدَّق |
| 403 | غير مُصرَّح (مستخدم غير مشرف يحاول تنفيذ إجراء مشرف) أو تم الوصول إلى حد الغرفة |
| 404 | الغرفة غير موجودة |
| 409 | تعارض (مورد مكرر) |
| 500 | خطأ داخلي في الخادم |
| 507 | تجاوز حصة التخزين (حد التحميل أو الحد العام) |
