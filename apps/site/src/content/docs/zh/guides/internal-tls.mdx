...
## See also
- [Installation Guide](/zh/docs/getting-started/installation) - install methods
- [Configuration Reference](/zh/docs/getting-started/configuration) - full config options
