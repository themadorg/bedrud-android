---
title: Docker 指南
description: 使用 Docker 运行 Bedrud
order: 29
---
...
- [Configuration Reference](/zh/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/zh/docs/guides/deployment) - production deployment with Docker
