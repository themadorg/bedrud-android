...
For server setup after installing, see [Quick Start](/zh/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/zh/docs/getting-started/installation).
