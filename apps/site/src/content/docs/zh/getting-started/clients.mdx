...
<Tabs>
  ...
  <TabsContent value="ubuntu-debian-apt">
    ...
    See the [Package Installation guide](/zh/docs/guides/packages) for repository setup.
  </TabsContent>
...
For the complete reference of all package managers, repositories, and platforms, see the [Package Installation Guide](/zh/docs/guides/packages).
