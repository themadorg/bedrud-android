---
title: 端到端加密
description: E2EE 架构、当前实现以及计划中的客户端加密
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/zh/e2ee).
...
- [WebRTC Connectivity](/zh/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/zh/docs/architecture/turn-server) — TURN relay configuration
