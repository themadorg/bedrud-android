...
> 请参阅[音乐代理 README](https://github.com/themadorg/bedrud/tree/main/agents/music_agent)获取设置和使用说明。
...
> 请参阅[广播代理 README](https://github.com/themadorg/bedrud/tree/main/agents/radio_agent)获取设置和使用说明。
...
> 请参阅[视频流代理 README](https://github.com/themadorg/bedrud/tree/main/agents/video_stream_agent)获取设置和使用说明。
...
- [音乐代理 README](https://github.com/themadorg/bedrud/tree/main/agents/music_agent) - 设置和使用
- [广播代理 README](https://github.com/themadorg/bedrud/tree/main/agents/radio_agent) - 设置和使用
- [视频流代理 README](https://github.com/themadorg/bedrud/tree/main/agents/video_stream_agent) - 设置和使用
