---
title: API 处理器
description: REST API 端点实现
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/zh/docs/api/api-reference).
...
- [Authentication](/zh/docs/backend/authentication)
- [Webhooks Guide](/zh/docs/guides/webhooks)
- [Configuration](/zh/docs/getting-started/configuration)
