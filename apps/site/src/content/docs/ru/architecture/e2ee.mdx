...
description: Архитектура E2EE, текущая реализация и планируемое клиентское шифрование
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/ru/e2ee).
...
- [WebRTC Connectivity](/ru/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/ru/docs/architecture/turn-server) — TURN relay configuration
