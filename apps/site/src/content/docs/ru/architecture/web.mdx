...
- [Система дизайна веб-приложения](https://github.com/themadorg/bedrud/tree/main/apps/web/AGENTS.md) - паттерны UI-компонентов, цветовые токены и правила стилизации
