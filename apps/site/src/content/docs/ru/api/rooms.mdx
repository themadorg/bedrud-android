...
| 403 | `"Room limit reached (max N active rooms)"` | Достигнут лимит комнат |
...
| 401 | Не авторизован |
| 403 | Нет прав (не-администратор пытается выполнить действие администратора) или достигнут лимит комнат |
| 404 | Комната не найдена |
| 409 | Конфликт (дублирование ресурса) |
| 500 | Внутренняя ошибка сервера |
| 507 | Превышена квота хранилища (лимит загрузки или глобальный порог) |
