...
description: Реализации REST-эндпоинтов
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/ru/docs/api/api-reference).
...
- [Authentication](/ru/docs/backend/authentication)
- [Webhooks Guide](/ru/docs/guides/webhooks)
- [Configuration](/ru/docs/getting-started/configuration)
