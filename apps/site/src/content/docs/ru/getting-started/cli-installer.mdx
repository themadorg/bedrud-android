...
For server setup after installing, see [Quick Start](/ru/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/ru/docs/getting-started/installation).
