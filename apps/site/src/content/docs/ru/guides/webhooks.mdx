---
title: Webhooks
description: Настройка и управление webhook-событиями
order: 37
---
...
- [Admin Dashboard](/ru/docs/guides/admin-dashboard) — UI for managing webhooks
- [API Reference](/ru/docs/api/api-reference) — Admin webhook endpoints in OpenAPI
