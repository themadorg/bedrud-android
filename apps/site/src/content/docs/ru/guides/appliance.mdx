...
| Встроенный установщик | Настраивает init-сервисы (systemd/OpenRC/SysV), директории и конфигурации |
...
После установки работают два init-сервиса (systemd, OpenRC или SysV init):
...
- Файлы init-сервисов (systemd/OpenRC/SysV)
