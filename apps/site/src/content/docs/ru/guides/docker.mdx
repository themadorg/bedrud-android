...
- [Configuration Reference](/ru/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/ru/docs/guides/deployment) - production deployment with Docker
