...
## See also
- [Installation Guide](/ru/docs/getting-started/installation) - install methods
- [Configuration Reference](/ru/docs/getting-started/configuration) - full config options
