...
Room creators and promoted moderators use the participant context menu and stage/share controls during a call. For host-facing behavior (mute, kick, screen share stop, spotlight, stage), see [Meeting Controls](/ru/docs/using/meeting-controls) and [Stage Mode](/ru/docs/using/stage-mode).
