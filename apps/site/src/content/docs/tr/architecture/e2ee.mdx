...
> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/tr/e2ee).
...
- [WebRTC Connectivity](/tr/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/tr/docs/architecture/turn-server) — TURN relay configuration
