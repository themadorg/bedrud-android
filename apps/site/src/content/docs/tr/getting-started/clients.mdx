...
<Tabs>
  ...
  <TabsContent value="ubuntu-debian-apt">
    ...
    See the [Package Installation guide](/tr/docs/guides/packages) for repository setup.
  </TabsContent>
...
For the complete reference of all package managers, repositories, and platforms, see the [Package Installation Guide](/tr/docs/guides/packages).
