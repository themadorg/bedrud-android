...
For server setup after installing, see [Quick Start](/tr/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/tr/docs/getting-started/installation).
