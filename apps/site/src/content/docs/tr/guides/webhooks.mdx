---
title: Webhooks
description: Webhook olaylarını yapılandırın ve yönetin
order: 37
---
...
- [Admin Dashboard](/tr/docs/guides/admin-dashboard) — UI for managing webhooks
- [API Reference](/tr/docs/api/api-reference) — Admin webhook endpoints in OpenAPI
