...
- [Configuration Reference](/tr/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/tr/docs/guides/deployment) - production deployment with Docker
