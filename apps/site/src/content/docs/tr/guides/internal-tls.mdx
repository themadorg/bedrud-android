...
## See also
- [Installation Guide](/tr/docs/getting-started/installation) - install methods
- [Configuration Reference](/tr/docs/getting-started/configuration) - full config options
