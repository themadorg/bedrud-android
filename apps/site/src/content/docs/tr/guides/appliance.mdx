...
| Yerleşik yükleyici             | init servisleri (systemd/OpenRC/SysV), dizinler ve yapılandırmaları ayarlar                    |
...
Kurulumdan sonra iki init servisi (systemd, OpenRC veya SysV init) çalışır:
...
- Init servis dosyaları (systemd/OpenRC/SysV)
