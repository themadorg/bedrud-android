...
## Toplantı içi moderasyon arayüzü

Oda oluşturucular ve yükseltilmiş moderatörler, arama sırasında katılımcı bağlam menüsünü ve sahne/paylaşım kontrollerini kullanır. Ev sahibine dönük davranış (sessize alma, atma, ekran paylaşımını durdurma, spotlight, sahne) için [Toplantı Kontrolleri](/tr/docs/using/meeting-controls) ve [Sahne Modu](/tr/docs/using/stage-mode) bölümlerine bakın.
