...
`/dashboard/admin/settings` adresindeki ayarlar sayfası 7 sekme halinde düzenlenmiştir. Herhangi bir sekmeyi değiştirdikten sonra "Değişiklikleri kaydet"e tıklayın (Genel sekmesi, kayıt modu değişikliklerinde otomatik kaydeder).
