---
title: API Handler'ları
description: REST API uç nokta uygulamaları
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/tr/docs/api/api-reference).
...
- [Authentication](/tr/docs/backend/authentication)
- [Webhooks Guide](/tr/docs/guides/webhooks)
- [Configuration](/tr/docs/getting-started/configuration)
