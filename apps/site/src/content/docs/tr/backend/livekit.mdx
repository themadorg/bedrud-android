...
- **TURN Port (3478 UDP / 5349 TLS):** Relays media for clients behind restrictive NATs or firewalls. See [TURN Server Guide](/tr/docs/architecture/turn-server).

For firewall and port requirements, see [WebRTC Connectivity](/tr/docs/architecture/webrtc-connectivity).
...
- [TURN Server Guide](/tr/docs/architecture/turn-server) - TURN architecture, configuration, TLS, and troubleshooting
