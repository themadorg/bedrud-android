...
- **Dağıtım:** init sistemi orkestrasyonu (systemd, OpenRC, SysV init) ve ACME (Let's Encrypt) desteğiyle entegre Debian/Ubuntu otomatik kurucu.
...
3.  İşletim sistemi düzeyindeki yapılandırmayı (SSL, init servisleri) ikili dosya kendisi aracılığıyla **otomatikleştirerek**.
