...
Oluşturduğunuz bir odayı silin. Bu, odayı ve tüm ilişkili verileri kalıcı olarak kaldırır. Bir arka plan işine kuyruğa alınır ve hemen döner.
...
| 403 | Oda oluşturucu değilsin (yalnızca oluşturan silebilir) |
| 404 | Oda bulunamadı |
| 409 | Silme zaten devam ediyor |
| 500 | Sunucu hatası |

Oda aktifse, tüm katılımcıların bağlantısı kesilir ve "This room has been ended by the creator" mesajını görürler.
...
| 403 | `"Room limit reached (max N active rooms)"` | Oda sınırına ulaşıldı |
...
| 403 | Yetkisiz (yönetici olmayan, yönetici eylemi deniyor) veya oda sınırına ulaşıldı |
| 404 | Oda bulunamadı |
| 409 | Çakışma (yinelenen kaynak) |
| 500 | İç sunucu hatası |
| 507 | Depolama kotası aşıldı (yükleme limiti veya küresel eşik) |
