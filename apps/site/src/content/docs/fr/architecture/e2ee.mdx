...
description: Architecture E2EE, implémentation actuelle et chiffrement côté client prévu
order: 15
---

> [!NOTE]
> Looking for a high-level summary or interactive WebRTC packet-flow demonstration? Check out our [End-to-End Encryption Landing Page](/fr/e2ee).
...
- [WebRTC Connectivity](/fr/docs/architecture/webrtc-connectivity) — ICE, STUN, TURN, and media routing
- [TURN Server Guide](/fr/docs/architecture/turn-server) — TURN relay configuration
