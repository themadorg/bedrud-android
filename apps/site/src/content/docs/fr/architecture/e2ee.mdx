...
> [!NOTE]
> Vous recherchez un résumé de haut niveau ou une démonstration interactive du flux de paquets WebRTC ? Consultez notre [page d'accueil du chiffrement de bout en bout](/fr/e2ee).
