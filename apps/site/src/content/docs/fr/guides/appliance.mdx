...
| Installateur intégré | Configure les services init (systemd/OpenRC/SysV), les répertoires et les configurations |
...
Après l'installation, deux services init (systemd, OpenRC ou SysV init) s'exécutent :
...
- Les fichiers de service init (systemd/OpenRC/SysV)
