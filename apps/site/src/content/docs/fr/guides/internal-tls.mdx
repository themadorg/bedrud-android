...
## See also
- [Installation Guide](/fr/docs/getting-started/installation) - install methods
- [Configuration Reference](/fr/docs/getting-started/configuration) - full config options
