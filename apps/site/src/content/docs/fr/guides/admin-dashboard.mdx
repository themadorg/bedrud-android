...
La page des paramètres à `/dashboard/admin/settings` est organisée en 7 onglets. Cliquez sur « Enregistrer les modifications » après avoir modifié un onglet (l'onglet Général s'enregistre automatiquement lors des changements de mode d'inscription).
...
- [API d'administration](/fr/docs/api/admin) — référence complète de l'API pour tous les points de terminaison admin
