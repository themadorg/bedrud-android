...
- [Configuration Reference](/fr/docs/getting-started/configuration) - full config options and environment variables
- [Deployment Guide](/fr/docs/guides/deployment) - production deployment with Docker
