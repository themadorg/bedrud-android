...
For server setup after installing, see [Quick Start](/fr/docs/getting-started/quickstart). For package managers, Docker, and other methods, see [Server Installation](/fr/docs/getting-started/installation).
