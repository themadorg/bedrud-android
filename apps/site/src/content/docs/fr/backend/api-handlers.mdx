---
title: Handlers API
description: Implémentations des endpoints REST
order: 19
---

Bedrud uses the **Fiber** web framework. Production routes are registered in `server/internal/server/server.go` (used by `bedrud run`). Interactive OpenAPI: [API Reference](/fr/docs/api/api-reference).
...
- [Authentication](/fr/docs/backend/authentication)
- [Webhooks Guide](/fr/docs/guides/webhooks)
